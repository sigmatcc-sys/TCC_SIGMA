...
export default function ManagerCompanies() {
    ...
    function saveCompany(updatedCompany) {
    ...
    return (
      ...
      ====================================== */}
            ...
            <aside
                className={`manager-companies-sidebar ${sidebarOpen
                    ? "open"
                    : ""
                    }`}
            >
                    ...
                    {menuItems.map((item) => {
                        ...
                        return (
                            ...
                            <Link
                                key={item.label}
                                to={item.path}
                                className={`manager-companies-menu-item ${isActive
                                    ? "active"
                                    : ""
                                    }`}
                                onClick={() =>
      ...
      ====================================== */}
            ...
            <DeleteModal
                ...
                message="Deseja realmente excluir esta empresa? Essa ação não poderá ser desfeita."
